...
public class ObservableNestScrollView extends NestedScrollView {
    ...
    public ObservableNestScrollView(Context context) {
        super(context);
    }

    public ObservableNestScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ObservableNestScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
